...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed top-0 left-0 w-2 h-2 bg-primary-600 dark:bg-primary-500 rounded-full pointer-events-none z-[9999]"
        style={{
          x: mouseX,
          y: mouseY,
          translateX: "-50%",
      ...
      <motion.div
        className="fixed top-0 left-0 w-8 h-8 border-[1.5px] border-primary-600/50 dark:border-primary-500/50 rounded-full pointer-events-none z-[9998]"
        style={{
          x: springX,
          y: springY,
          translateX: "-50%",
