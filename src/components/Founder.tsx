          ...
          {founders.map((founder, index) => (
            ...
            >
              <motion.div
                ...
                className="h-full flex flex-col bg-white dark:bg-gray-950 rounded-3xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-800 hover:shadow-2xl dark:hover:shadow-primary-900/20 transition-all duration-300 group"
              >
                <div className="relative h-80 w-full bg-gray-100 dark:bg-gray-800 overflow-hidden shrink-0">
                  <Image
                    src={founder.image}
                    alt={founder.name}
                    fill
