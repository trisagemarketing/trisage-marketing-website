        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 lg:mb-16">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 dark:text-white leading-[1.2] tracking-tight">
              Marketing Solutions for Every Type of <span className="text-transparent bg-clip-text bg-linear-to-r from-secondary-600 to-secondary-400 dark:from-secondary-400 dark:to-secondary-300">Hospitality Business</span>
            </h2>
          </motion.div>
        </div>
          ...
          <div className="animate-marketing-marquee flex w-max">
            ...
            {[...solutions, ...solutions].map((solution, index) => (
              <div key={index} className="shrink-0 w-[85vw] sm:w-85 md:w-100 lg:w-105 pr-6 h-auto">
                ...
                <div className="group relative w-full aspect-4/5 rounded-3xl overflow-hidden flex flex-col justify-between transform-gpu will-change-transform bg-gray-900 shadow-sm hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="absolute inset-0 bg-linear-to-b from-black/70 via-black/10 to-black/80 z-10 opacity-90 group-hover:opacity-100 transition-opacity duration-500" />
