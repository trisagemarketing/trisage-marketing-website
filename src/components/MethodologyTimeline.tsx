                ...
                <div className={cn(
                  ...
                  <motion.div variants={fadeUp} className="w-full lg:flex-1 flex justify-end lg:justify-center relative z-30 -mt-16 md:-mt-24 lg:mt-0 pr-4 md:pr-12 lg:pr-0 pointer-events-none will-change-transform">
                    <div className="relative p-6 md:p-12 flex items-center justify-center group-hover:scale-105 transition-transform duration-700 pointer-events-auto">
                      ...
                      <div className="relative z-10 w-28 h-28 md:w-40 md:h-40 lg:w-56 lg:h-56 bg-white/70 dark:bg-black/40 backdrop-blur-3xl border border-white/60 dark:border-white/20 rounded-3xl lg:rounded-[2.5rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] dark:shadow-2xl flex items-center justify-center transform transition-all duration-500 lg:group-hover:rotate-6">
