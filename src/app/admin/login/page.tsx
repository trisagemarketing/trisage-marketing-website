...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] pb-[env(safe-area-inset-bottom)] z-50 flex items-center justify-center bg-[#f3fbf9] dark:bg-[#050b14] relative py-10 px-4 overflow-hidden">
